...
#         df_first_hidden_layer.head()
        ...
        for i, (train_index, test_index) in enumerate(stratified.split(X, y)):
            print(f'{i+1}/{stratified_split * stratified_repeat} - training-validation-testing split!!!')
...
#         df_result_threshold_score.to_csv((f'./experiment_{dataset_name}_lof_training_val_threshold_scores.csv'))
        ...
        df_result_pred_truth.to_parquet(f'./paper2_figures_for_Review/report/experiment_{data_name}_testing_result_{stratified_split * stratified_repeat}.parquet')
        df_result_similarity.to_parquet(f'./paper2_figures_for_Review/report/experiment_{data_name}_lof_training_val_result_{stratified_split * stratified_repeat}.parquet')
        df_result_threshold_score.to_parquet((f'./paper2_figures_for_Review/report/experiment_{data_name}_lof_training_val_threshold_scores_{stratified_split * stratified_repeat}.parquet'))
        
        df_result_pred_truth.to_csv(f'./paper2_figures_for_Review/report/experiment_{data_name}_testing_result_{stratified_split * stratified_repeat}.csv')
        df_result_similarity.to_csv(f'./paper2_figures_for_Review/report/experiment_{data_name}_lof_training_val_result_{stratified_split * stratified_repeat}.csv')
        df_result_threshold_score.to_csv((f'./paper2_figures_for_Review/report/experiment_{data_name}_lof_training_val_threshold_scores_{stratified_split * stratified_repeat}.csv'))
